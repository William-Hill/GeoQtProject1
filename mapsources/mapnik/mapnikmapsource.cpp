...
MapnikMapSource::MapnikMapSource()
	: MapSourceInterface()
{
}

QString MapnikMapSource::name()
{
	return QString("mapnik");
}

QString MapnikMapSource::license()
{
	return QString("Map data is CC-BY-SA 2.0 OpenStreetMap contributors");
}

QString MapnikMapSource::urlTemplate()
{
	return QString("http://tile.openstreetmap.org/#Z#/#X#/#Y#.png");
}

int MapnikMapSource::maxZoom()
{
	return 18;
}

int MapnikMapSource::minZoom()
{
	return 0;
}

int MapnikMapSource::tileSize()
{
	return 256;
}

QPointF MapnikMapSource::coordinateFromDisplay(const QPoint &point, int zoom)
{
...
QPoint MapnikMapSource::displayFromCooordinate(const QPointF &coordinate, int zoom)
{
	int tiles_size = (1 << zoom) * tileSize();
...
bool MapnikMapSource::isValidCoordinate(const QPointF &coordinate)
{
...
Q_EXPORT_PLUGIN2(mapnikmapsource, MapnikMapSource)
